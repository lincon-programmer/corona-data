...
module.exports = (app) =>{
    ...
    */
     ...
     *            name: data
     *            type: string
     *      summary: Rota com os dados de infectados do estado Piauí
     *      description: listagem de dados contendo Os municipios do Piauí que foram infectados pelo coronavírus, essa lista é atulizada todos os dias ás 19h00, O formato de data que deve ser inserido é DD-MM-AAAA.
     *      responses:
     *          200:
     *              schema:
     *                  type: object
     ...
     *                                  example: 0
    */
    app.get(listRouters.pi, listdata.pi());
    /**
     * @swagger
     * /RS/{data}:
     *    get:
     ...
     *            name: data
     *            type: string
     *      summary: Rota com os dados de infectados do estado do Rio Grande Do Sul
     *      description: listagem de dados contendo Os municipios do Rio Grande Do Sul que foram infectados pelo coronavírus, essa lista é atulizada todos os dias ás 19h00, O formato de data que deve ser inserido é DD-MM-AAAA.
     *      responses:
     *          200:
     *              schema:
     *                  type: object
     ...
     *                                  example: 0
    */
    app.get(listRouters.rs, listdata.rs());
}